...
namespace BFL
{
  ...
  */
  ...
  {
    std::cout << "AnalyticSystemModelGaussianUncertainty::df_dxGet" << std::endl;
  ...
  {
    std::cout << "AnalyticSystemModelGaussianUncertainty::PredictionGet" << std::endl;
  ...
  {
    std::cout << "AnalyticSystemModelGaussianUncertainty::CovarianceGet" << std::endl;
    SystemPdfGet()->ConditionalArgumentSet(0,x);
    if (SystemPdfGet()->NumConditionalArgumentsGet() == 2) 
      SystemPdfGet()->ConditionalArgumentSet(1,u);
