		          ...
		          void * sampling_args)
{
  ...
  _SystemPdf->ConditionalArgumentSet(0,x); //设置参数 第一个参数为x
  _SystemPdf->ConditionalArgumentSet(1,u); //设置参数 第二个参数为u
  Sample<T> Simulated(StateSizeGet()); // 新建实例 
