# Install script for directory: /home/finley/CODE/bfl-release/examples/nonlinear_particle
...
file(INSTALL DESTINATION "/usr/local/bin/bfl" TYPE EXECUTABLE PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE FILES "/home/finley/CODE/bfl-release/build/examples/nonlinear_particle/test_nonlinear_particle")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/bfl/test_nonlinear_particle" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/bfl/test_nonlinear_particle")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/bfl/test_nonlinear_particle"
